...
public enum ItemContainerDetector implements FileAnalyzer, DBSingleStorage {
  ...
  public void analyzeItem(FileContext context) {
    try {
      ...
      metadata.add(Metadata.MIME_TYPE_MAGIC, context.getPath().toFile().toString());
      ...
      System.out.println(context.getPath().getFileName() + " Mime: " + metadata.get(Metadata.CONTENT_TYPE));
