...
public final class FileAnalyzers {
	...
	private static Analyzer<?, ?> newInstance(String AnalyzerName) {
		...
		/*
		FileAnalysisProvider ap = fileAnalysisProviders.get(AnalyzerName);
		if (ap == null)
			throw new IllegalArgumentException("No Analysis Provider registered with name: " + AnalyzerName);
		return ap.newAnalyzer();*/
	}
}
